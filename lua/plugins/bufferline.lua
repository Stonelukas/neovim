return 
{
    ...
    -- },
    {
        ...
        config = function()
            ...
            vim.api.nvim_set_keymap("n", "<leader>p", "<Plug>(cokeline-switch-prev)", { silent = true, desc = "switch to Previous buffer" })
            vim.api.nvim_set_keymap("n", "<leader>n", "<Plug>(cokeline-switch-next)", { silent = true, desc = "switch to Next buffer" })
