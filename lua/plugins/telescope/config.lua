...
telescope.setup({
    ...
    extensions = {
        ...
        cder = {
            previewer = true,
            theme = "ivy",
            previewer_command = "exa " .. "-a " .. "--color=always " .. "-T " .. "--level=3 " .. "--icons " ..
                "--git-ignore " .. "--long " .. "--no-permissions " .. "--no-user " .. "--no-filesize " .. "--git " ..
                "--ignore-glob=.git",
            mappings = {
        ...
        menu = {
            filetype = {
                lua = {
                    items = {{"Format", "!stylua %"}, {"Open Luadev menu", "Luadev"},
                             {"Execute a current buffer", "LuaRun"}}
                }
            },
            default = {
                items = { -- You can add an item of menu in the form of { "<display>", "<command>" }
                {"Checkhealth", "checkhealth"}, {"Show LSP Info", "LspInfo"}, {"Files", "Telescope find_files"},
            ...
            editor = {
                items = {{"Split window vertically", "vsplit"}, {"Split window horizontally", "split"}, {"Write", "w"}}
            }
        },
        zoxide = {
        ...
        picker_list = {
            ...
            user_pickers = {{"todo-comments", function()
                vim.cmd([[TodoTelescope ]])
            end}, {'urlview local', function()
                vim.cmd([[UrlView]])
            end}, {'urlview lazy', function()
